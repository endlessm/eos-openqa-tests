...
| `OS_UPDATE_TO_STAGE_PASSWORD` | String | Undefined | Should be set exactly when `OS_UPDATE_TO` is set. It provides the password for the stage given by `OS_UPDATE_TO_STAGE`. It will be used to run `eos-stage-ostree` before updating. Specific to eos-openqa-tests. |
