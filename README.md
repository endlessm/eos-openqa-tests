...
| `OS_UPDATE_TO_REFSPEC` | OSTree refspec string | Undefined | The ref that the system should be set to when upgrading it complete. Should be set exactly when `OS_UPDATE_TO` is set. |
